...
@validation_wrapper
def check_in_range_string_length(df: pd.DataFrame = None, column_name: str = "", length_range: Tuple[int, int] = (0, 255)) -> Tuple[pd.Series, str]:
    ...
    # convert to string -> should in preporcessing
