...
error_message_formats: Dict = {
        ...
        "invalid_value": "{} must be in {}",
        "refered_required": "{} is required when {} is {}",
        "refered_invalid_value": "{} must be {} when {} is {}"
    }
...
def check_config(config_file_path: str = ""):
    ...
    df["source_status"] = df["source_status"].map(lambda x: "active" if x == True else "error")
